...
<html>
  <head>
	...
	<script type="text/javascript" src="${basePath}static/js/module/theme/themeGoods.js"></script>
  ...
  <body>
    ...
    <!-- 店铺列表 -->
    <table id="themeGoodsDatagrid"></table>
	...
	<div id="goodsWindow" class="easyui-window" data-options="closed:true,shadow:false,modal:true" style="width:600px;height:400px;top:100px">
		...
		<div id="toolbar_goods" style="height:auto">
		<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true" onclick="removeGoods()">删除</a>
		</div>
	</div>
	
	<!-- 添加主题商品 -->
	<div id="themeGoodsWindow" class="easyui-window" data-options="iconCls:'icon-save',closed:true" style="width:500px;height:350px;padding:10px;top:100px">
         <div align="center">
		    <form id="themeGoodsForm" method="post">
		    	<input  type="hidden" id="themeGoodsId" name="themeGoodsId"/>
		    	<input  type="hidden" id="add_goodsId" name="goodsIds"/>
			    <table>
				    <tr height="40px">
				        <td>主题:</td>
					    <td>
					      <input class="easyui-validatebox" type="text" id="themeId" name="themeId"  style="width:250px">
					    </td>
				    </tr>
				    <tr height="40px">
				        <td>商品:</td>
					    <td>
					      <input class="easyui-validatebox" type="text" id="goodsId" name="add_goodsId" style="width:250px">
					    </td>
				    </tr>
			    </table>
		    </form>
	   ...
	   <div style="text-align:center;padding:10px">
		    ...
		    <a href="javascript:void(0)" class="easyui-linkbutton" iconcls="icon-no" onclick="closeWin('themeGoodsWindow')">关 闭</a>
	   </div>
	</div>
