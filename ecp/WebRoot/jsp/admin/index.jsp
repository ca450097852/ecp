...
<base href="<%=basePath%>">
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath%>plugins/websocketInstantMsg/ext4/resources/css/ext-all.css">
	<link rel="stylesheet" type="text/css" href="<%=basePath%>plugins/websocketInstantMsg/css/websocket.css" />
	<script type="text/javascript" src="<%=basePath%>plugins/websocketInstantMsg/ext4/ext-all-debug.js"></script>
	<script type="text/javascript" src="<%=basePath%>plugins/websocketInstantMsg/websocket.js"></script>
	<!-- 即时通讯 -->
...
<body>
	...
	<div class="container-fluid" id="main-container">
		...
		<div id="main-content" class="clearfix">
			...
			<div>
				<iframe name="mainFrame" id="mainFrame" frameborder="0" src="jsp/admin/tab.jsp" style="margin:0 auto;width:100%;height:100%;"></iframe>
			</div> 
