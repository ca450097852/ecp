...
<html>
  <head>
    ...
    <!-- easyui end -->
    <script type="text/javascript" src="static/js/module/sys/user.js"></script>
  ...
  <body>
	    ...
	    <div id="myWindow" class="easyui-window" data-options="iconCls:'icon-save',closed:true" style="width:700px;height:400px;padding:10px;top:50px">
					     <form id="userForm" method="post">
						    ...
						    <table >
							    <tr height="40px">
							        <td>所属机构:</td>
								    <td>
								      <input class="easyui-validatebox" type="text" id="entId" name="entId" style="width:250px">
								    </td>
								    <td>用户名称:</td>
								    <td>
								      <input class="easyui-validatebox" type="text" id="nickname" name="nickname" required="true" style="width:250px">
								    </td>
							    </tr>
							    <tr height="40px">
							        <td>用户账号:</td>
								    <td>
								      <input class="easyui-validatebox" type="text" id="userName" name="userName" required="true" style="width:250px">
								    </td>
								    <td>用户密码:</td>
								    <td>
								      <input class="easyui-validatebox" type="password" name="password" required="true" style="width:250px">
								    </td>
							    </tr>
							    <tr height="40px">
							        <td>性别:</td>
								    <td>
								      	<select id="sex"  name="sex" style="width:250px;">   
								    ...
								    <td>出生日期:</td>
								    <td>
								      <input class="easyui-datebox" type="text" name="birthDate" id="birthDate" style="width:250px">
								    </td>
							    </tr>
							    <tr height="40px">
							        <td>用户性质:</td>
								    ...
								    <td>用户状态:</td>
								    <td>
								      <select id="userSts"  name="sts" style="width:250px;">   
							    ...
							    <tr height="40px">
							        <td>联系地址:</td>
								    <td>
								      <input class="easyui-validatebox" type="text" name="addr"  style="width:250px">
								    </td>
								    <td>联系电话:</td>
								    <td>
