...
<html>
  <head>
    <base href="<%=basePath%>">
		...
		<script src="buy/AmazeUI-2.4.2/assets/js/jquery.min.js" type="text/javascript"></script>
		<script src="buy/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
		
		<script type="text/javascript" src="static/js/layer/layer.js"></script>
		<script src="buy/customJs/address.js"></script>
						...
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<div class="add-dress">
								...
								<div class="am-cf am-padding">
									<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg" >编辑地址</strong> / <small>Manage&nbsp;address</small></div>
								</div>
								<hr/>
									...
									<form id="doc-vld-msg" class="am-form am-form-horizontal">
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<input type="text" id="recipient" name="recipient" placeholder="收货人" required><span id="recipientSpan"></span>
											</div>
										</div>
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<input id="mobile" placeholder="手机号必填" name="mobile" type="text" required><span id="mobileSpan"></span>
											</div>
										</div>
										<div class="am-form-group">
											<label for="user-phone" class="am-form-label">电话号码</label>
											<div class="am-form-content">
												<input id="telephone" placeholder="电话号码选填" name="telephone" type="text" ><span id="telephoneSpan"></span>
											</div>
										</div>
										<div class="am-form-group">
											<label for="user-postCode" class="am-form-label"  >邮政编码</label>
											<div class="am-form-content">
												<input id="postCode" placeholder="邮政编码必填" name="postCode" type="text" required><span id="postCodeSpan"></span>
											</div>
										</div>
										<div class="am-form-group">
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<textarea class="" rows="3" id="addr" name="addr" placeholder="输入详细地址"></textarea><span id="addrSpan"></span>
										...
										<div class="am-form-group">
											<div class="am-u-sm-9 am-u-sm-push-3">
												<a href="javascript: void(0)" class="am-btn am-btn-danger" onclick="submit()">保存</a>
												<a href="javascript: void(0)" class="am-close am-btn am-btn-danger" onclick="reset()">重置</a>
											</div>
										</div>
									</form>
								</div>
