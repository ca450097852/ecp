  ...
  <div class="weui-tab">
    ...
    <div class="weui-flex" >
      ...
      <div class="weui-flex__item"><div id="salePrice" class="placeholder SortDescCss">按价格</i></div></div>
        ...
        <div class="weui-panel weui-panel_access" style="padding-top:30px;">
...
<div class="weui-tabbar wy-foot-menu">
  ...
  <a href="javascript:;" onclick="$.alert('预留功能');"  class="weui-tabbar__item yellow-color open-popup" data-target="#join_cart">
