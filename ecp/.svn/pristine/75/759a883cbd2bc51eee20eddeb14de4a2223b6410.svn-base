...
<html>
	<head>
		...
		<script type="text/javascript" src="seller/js/goods/updateGoods.js"></script>
		<link href="static/css/web/addGoods.css" rel="stylesheet"	type="text/css" />
	...
	<div class="center">
			<div class="col-main">
				...
				<div class="am-cf am-padding">
							<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">商品信息</strong> / <small>Shop&nbsp;information</small></div>
						</div>
						<hr/>
