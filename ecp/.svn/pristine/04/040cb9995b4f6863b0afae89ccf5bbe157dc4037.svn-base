...
$(function(){
	...
	if(search=="null"){
		...
		goodsName=decodeUnicode(search);
		$('#goodsFind').val(decodeUnicode(search));
	}
...
//	op += '<dd><ul>';
	...
	op +='<li><a id="priceId0" onclick="priceChang(0)" style="cursor:pointer;">全部</a></li>\
		<li><a id="priceId1" onclick="priceChang(1)" style="cursor:pointer;"> < 50</a></li>\
		<li><a id="priceId2" onclick="priceChang(2)" style="cursor:pointer;">50 - 100</a></li>\
		<li><a id="priceId3" onclick="priceChang(3)" style="cursor:pointer;">100 - 200</a></li>\
		<li><a id="priceId4" onclick="priceChang(4)" style="cursor:pointer;">200 - 300</a></li>\
		<li><a id="priceId5" onclick="priceChang(5)" style="cursor:pointer;">300 - 400</a></li>\
		<li><a id="priceId6" onclick="priceChang(6)" style="cursor:pointer;">400 - 500</a></li>\
...
function priceChang(index){
	...
	if(index==0){
		...
		priceSql=" and saled_price < 50 ";
	}else if(index==2){
		priceSql=" and saled_price between 50 and 100 ";
	}else if(index==3){
		priceSql=" and saled_price between 100 and 200 ";
	}else if(index==4){
		priceSql=" and saled_price between 200 and 300 ";
	}else if(index==5){
...
function getGoodsListHtml(typeIds,orderBy){
	...
	var parm = {"page":page,"rows":nums,"typeIds":typeIds,"orderBy":orderBy,"brandId":brandId,"priceSql":priceSql,"goodsName":goodsName};
	$.ajax({
		   type: "POST",
		   data: parm,
...
//	window.location.href=basePath+"web/seller.jsp?shopId="+shopId;
	window.open(basePath+"web/seller.jsp?shopId="+shopId,"_blank");
}
