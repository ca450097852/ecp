...
<html>
  <head>
	...
	<script type="text/javascript" src="${basePath}static/js/module/goods/goodsType.js"></script>
  ...
  <body>
	...
	<!-- 添加栏目菜单 -->
	<div id="sysColWindow" class="easyui-window" data-options="iconCls:'icon-save',closed:true" style="width:400px;height:350px;padding:10px;top:100px">
         <div align="center">
		    <form id="goodsTypeForm" method="post">
			    ...
			    <table>
				    ...
				    <tr height="35px">
				       <td class="form_label">分类图片:</td>
					    <td>
					    	<input type="hidden" id="typeImg" name="typeImg"/>
					        <input type="file" id="typeImgFile"><span id="imgfanbox" style="width:15px;height:auto"><span>
					        <div id="quenu"></div>
					    </td>
				    </tr>
				    <tr height="35px">
