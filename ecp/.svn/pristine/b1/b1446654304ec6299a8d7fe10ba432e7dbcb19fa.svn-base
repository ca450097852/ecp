		...
		<div class="center">
			<div class="col-main">
				<div class="main-wrap">
					...
					<iframe  src="<%=basePath%>web/goods/GoodsList.jsp" style="margin:0 auto;width:100%;height:600px;"></iframe>
			...
			<aside class="menu">
				<ul>
					...
					<li class="person">
						...
						<ul>
							<li class="active"><a href="web/goods/iframe-goods.jsp">商品信息</a></li>
