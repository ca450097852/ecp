					...
					<div class="am-container header">
						...
						<ul class="message-r">
							...
							<div class="topMessage my-shangcheng">
								<div class="menu-hd MyShangcheng"><a href="buy/custom/index.jsp" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div>
							</div>
							<div class="topMessage my-shangcheng">
...
<!-- 								<div class="menu-hd"><a href="#" target="_top"><i class="am-icon-heart am-icon-fw"></i><span>收藏夹</span></a></div> -->
						...
						<div class="nav white">
							<div class="logoBig">
								<li><img src="${basePath}seller/images/logobig.png" /></li>
							</div>
...
<!-- 							</div> -->
		  ...
		  <div class="nav-table">
					   ...
					   <div class="nav-cont">
							<ul>
								<li class="index"><a href="seller/shop/myshop.jsp">首页</a></li>
								<li class="qc"><a href="seller/shop/myshop.jsp">店铺管理</a></li>
                                <li class="qc"><a href="seller/goods/goods.jsp">商品管理</a></li>
                                <li class="qc last"><a href="seller/order/order.jsp">订单管理</a></li>
							</ul>
							<!-- 后期需要再添加
						    <div class="nav-extra">
