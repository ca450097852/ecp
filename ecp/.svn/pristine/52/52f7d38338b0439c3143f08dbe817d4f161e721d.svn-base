...
public class WapMemberController extends BaseController{
	...
	public void addMember2(TbMember member,TbMemberUser memberUser,HttpServletResponse response,HttpSession session){
		writeJson2View(memberService.registerMember2(member,memberUser,session), response);
	}
