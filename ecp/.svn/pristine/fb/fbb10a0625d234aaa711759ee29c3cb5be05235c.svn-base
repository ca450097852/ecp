...
import com.hontek.member.dao.MeberLevel2Dao;
...
@Service("meberLevelService2")
public class MemberLevel2ServiceImpl extends BaseServiceImpl implements MemberLevel2Service{

	private MeberLevel2Dao meberLevelDao;
	
	@Autowired
	public void setMeberLevelDao(MeberLevel2Dao meberLevelDao) {
	...
	public Grid findMemberLevelList(SearchPageUtil pageUtil) {
		...
		List<TbMemberLevel2> list = meberLevelDao.findPageList(pageUtil);
