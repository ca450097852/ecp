...
<link href="seller/AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet"
	type="text/css">
<link href="seller/AmazeUI-2.4.2/assets/css/amazeui.css" rel="stylesheet"
	type="text/css">

<link href="seller/css/personal.css" rel="stylesheet" type="text/css">
<link href="seller/css/cmstyle.css" rel="stylesheet" type="text/css">

<script type="text/javascript" src="seller/js/jquery-1.7.2.min.js"></script>
<script src="seller/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
<style type="text/css">
...
<body>
	...
	<div class="center">
		<div class="col-main">
			...
			<!--底部-->
			<%@include file="../common/sellerFooter.jsp"%>
		</div>
		<!-- 左侧导航栏 -->
		<%@include file="../common/sellerLeft.jsp"%>
	</div>


	<script type="text/javascript" src="static/js/layer/layer.js"></script>
	<script type="text/javascript" src="seller/js/order/comment.js"></script>
</body>
</html>
