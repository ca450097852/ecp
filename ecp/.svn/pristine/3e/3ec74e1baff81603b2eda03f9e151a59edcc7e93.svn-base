...
public class MatrixToImageWriterEx {
	...
	public static void main(String[] args) {
		try {
			int width = 200;
			int height = width;
			String content = "http://seed.hontek.com.cn/seed/trace.jsp";
			...
			MatrixToImageWriterEx.writeToFile(matrix, "png", "d:/imgQRCode"+width+".png", "d:/logo.jpg", logoConfig);
			
			//MatrixToImageWriterEx.writeToFile(matrix, "png", "d:/imgQRCode"+width+".png");
