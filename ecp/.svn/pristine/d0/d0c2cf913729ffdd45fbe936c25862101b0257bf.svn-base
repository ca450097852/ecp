...
TouchAction.prototype = {
    ...
    set: function(value) {
        ...
        this.mobiles = value.toLowerCase().trim();
    },
...
+ function($) {
  ...
  var defaults = $.mobiles.prototype.defaults = {
    title: undefined,
    onClose: undefined,
    /*actions: [{
      text: "菜单",
...
+ function($) {
  ...
  $.fn.slider2 = function (arg) {//unpdate by zhang 20170919
    this.each(function () {
      var $this = $(this)
