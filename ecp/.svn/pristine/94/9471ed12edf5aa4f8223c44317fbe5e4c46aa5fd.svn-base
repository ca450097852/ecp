...
<body>
	...
	<div
		...
		<div id="loginbox">
			<form action="" method="post" name="loginForm"
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							</span><input type="text" name="loginname" id="loginname" value="administrator" placeholder="请输入用户名" />
						</div>
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							</span><input type="password" name="password" id="password" placeholder="请输入密码" value="hontek" />
						</div>
					</div>
				</div>
				...
				<div class="form-actions">
					<div style="width:86%;padding-left:8%;">
						...
						<div style="float: left;">
							<i><img style="height:22px;" src="<%=basePath%>jsp/login/SecurityCode.jsp" id="imgCode" alt="点击更换"
								title="点击更换"  onclick="reloadCode()"/></i>
						</div>
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © THINK-WORLD 2016</span></font>
				</div>
			</div>
		</div>
	</div>
		...
		function check() {
			...
			if ($("#code").val() == "") {
				...
				$.ajax({
					async:false,
					type: "POST",
					url: '<%=basePath%>jsp/login/login_ajax.jsp',
			    	data: {"code":$("#code").val()},
					cache: false,
