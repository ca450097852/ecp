...
public class TbGoods {
	...
	private String recommend;//1是，2否；默认2
	
	private Float agencyPrice1;//最低推荐价格
	private Float agencyPrice2;//最高推荐价格
	...
	public Integer getGoodSeq() {
		return goodSeq;
	}
	public void setGoodSeq(Integer goodSeq) {
	...
	public Integer getThemeGoogsId() {
		return themeGoogsId;
	}
	public void setThemeGoogsId(Integer themeGoogsId) {
		this.themeGoogsId = themeGoogsId;
	}
	public Float getAgencyPrice1() {
		return agencyPrice1;
	}
	public void setAgencyPrice1(Float agencyPrice1) {
		this.agencyPrice1 = agencyPrice1;
	}
	public Float getAgencyPrice2() {
		return agencyPrice2;
	}
	public void setAgencyPrice2(Float agencyPrice2) {
